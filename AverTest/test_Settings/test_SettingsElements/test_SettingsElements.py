...
def test_setup():
  ...
  TestName = "test_SettingsElements"
  description = "This test scenario is to verify all the Elements present at Settings page"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
  TestDirectoryName = "test_SettingsElements"
  global Exe
  Exe="Yes"
