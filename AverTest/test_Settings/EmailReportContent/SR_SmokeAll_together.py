...
def test_ReportSendSmokeAll():
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />Here is the test summary report of Test Suite 9 ( Settings ) <br />Below test scenarios are covered </p>
                <p></p>
                <p>'''+B+'''</p
                <p></p>
    ...
    RandmStr = "Gagan@0309"
    msg = MIMEMultipart()
    msg['Subject']='[Smoke Test 9 (Settings)]-Test Automation Report-Env [Test]'
    msg['From'] = email_from
