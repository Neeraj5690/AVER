...
def test_setup():
  ...
  TestName = "test_DownloadsWorkingReportCSV"
  description = "This test scenario is to verify download process of Report CSV file"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_VerifyAllClickables(test_setup):
    if Exe == "Yes":
        ...
        try:
            ...
            # --------------Generating Report CSV file from invoice entry table-------------------------------------
